...
typedef enum bit[2:0] {
    ...
    eRVMUL = 3'b100  // RV Integer Multiply.
} fma_opcode_e;

parameter integer fp32_exp_p = 8;   // FP32 exponent width
parameter integer fp32_sig_P = 23;  // FP32 significand width

parameter integer fp64_exp_p = 11;  // FP64 exponent width
parameter integer fp64_sig_P = 52;  // FP64 significand width
